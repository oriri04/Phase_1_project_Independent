                ...
                calculateCostButtons.forEach(button => {
                    button.addEventListener('click', function() {
                        ...
                        if (!isNaN(floorArea) && !isNaN(costRate) && !isNaN(constructionRate)) {
                            ...
                            // Display construction cost and period below the house description
                            constructionCostContainer.innerHTML = `<p>Construction cost: $${constructionCost.toFixed(2)}</p>`;
                            constructionPeriodContainer.innerHTML = `<p>Construction period: ${constructionPeriod.toFixed(2)} months</p>`;
                        } else {
